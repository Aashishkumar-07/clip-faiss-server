...
from services.fastvlm_caption import handle_generate_caption
...
def add_to_index(vectorstore: FAISS, coords: dict, img_filename: str):
  ...
  # caption generation from FastVLM
  generated_caption = handle_generate_caption(img_filename)
  ...
  id = str(os.path.splitext(img_filename)[0].split("_", 1)[1])
